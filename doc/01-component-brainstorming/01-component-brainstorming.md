...
Some of my interests and hobbies, unrelated to computer science, include music, reading, movies, etc. Some
computer science topics I find interesting are artificial intelligence and data analytics. A career goal I have for
the future is to get involved in some type of research.
...
- Component Design #1: Shape
  - **Description**:
  - **Kernel Methods**: This is a component that models a 2D polygon with sides of equal length. The
kernel methods will allow you to get and set the number of sides the shape has, and the side
lengths of the shape. Then, the secondary methods could be used to modify the shape, or get
more information about it, like area, perimeter, etc.
  int setSideLength(): sets the side lengths of this
int getSideLength(): get the side lengths of this
int setNumberOfSides(): set the number of sides this has
int getNumberOfSides(): gets the number of sides in this
  - **Secondary Methods**:
  void scale(int f): changes the size of this by a factor of f
int area(): returns the area of this
int perimeter(): returns the perimeter of this
int getNumberOfSides(): gets the number of sides in this

- Component Design #2: inventory
  - **Description**: A component that can be used to keep track of the quantities of ingredients and
products that a store/restaurant or similar establishment has on hand. The kernel methods allow
you to modify your inventory by adding or removing items, and use getter methods to check
how many of a certain item you have. The secondary methods will provide more information
about what you can do with your current inventory.
  - **Kernel Methods**:
void add(String item, int x): adds x of an item to this
void remove(String item, int x): removes x of this
int size(): amount of items in this
int itemCount(String item): how many of the item this has
  - **Secondary Methods**:
String[] shoppingList(String... args): returns a list of all items in the parameter
list that are currently not in the inventory.
boolean haveEnough(String item, int x): returns whether or not this has x or
more of the item

- Component Design #3: Album
  - **Description**: : Component that models a music album, containing a list of songs. The kernel
methods allow you to add songs, and includes details about them like title and run time. With
the secondary methods you can do things like shuffle the album, play/pause songs, etc
  - **Kernel Methods**:
  void add(String title, int length): adds a song that is length seconds long to this
int size(): returns number of songs in this
  - **Secondary Methods**:
  void shuffle(): randomly selects a song to play in this
String nowPlaying(): returns the song being played
boolean hasBeenPlayed(String title): returns whether or not a song in the album
has been played yet
